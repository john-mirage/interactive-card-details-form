...
class AppCardFront extends HTMLDivElement {
  ...
  connectedCallback() {
    if (this.#initialCall) {
      ...
      this.svgImageElement.setAttribute("x", "32");
      this.svgImageElement.setAttribute("y", "32");
      ...
      this.numberElement.setAttribute("x", "32");
      this.numberElement.setAttribute("y", "164");
      this.holderElement.setAttribute("x", "32");
      this.holderElement.setAttribute("y", "208");
      this.expirationElement.setAttribute("x", "364");
      this.expirationElement.setAttribute("y", "208");
